          ...
          <div class="card-body">
            ...
            <form action="{{ route('articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="category" class="form-select" required>
                    ...
                    <option value="insight" {{ old('category', $article->category) == 'insight' ? 'selected' : '' }}>Insight</option>
                  </select>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="content" id="description" class="form-control" rows="6">{{ old('content', $article->content) }}</textarea>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  @if ($article->featured_image)
                    <div class="mb-2">
                      <img src="{{ asset('storage/' . $article->featured_image) }}" alt="Featured Image" class="rounded shadow-sm" width="180">
                    </div>
                  @endif
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  @if ($article->meta_image)
                    <div class="mb-2">
                      <img src="{{ asset('storage/' . $article->meta_image) }}" alt="Meta Image" class="rounded shadow-sm" width="180">
                    </div>
                  @endif
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="meta_keyword" value="{{ old('meta_keyword', $article->meta_keyword) }}" class="form-control">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="og_title" value="{{ old('og_title', $article->og_title) }}" class="form-control" placeholder="If empty, will use Meta Title">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="og_description" class="form-control" rows="2" placeholder="If empty, will use Meta Description">{{ old('og_description', $article->og_description) }}</textarea>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="canonical_url" value="{{ old('canonical_url', $article->canonical_url) }}" class="form-control" placeholder="https://example.com/article-slug">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="robots" class="form-select">
                    <option value="index, follow" {{ old('robots', $article->robots) == 'index, follow' ? 'selected' : '' }}>index, follow</option>
                    <option value="noindex, follow" {{ old('robots', $article->robots) == 'noindex, follow' ? 'selected' : '' }}>noindex, follow</option>
                    <option value="index, nofollow" {{ old('robots', $article->robots) == 'index, nofollow' ? 'selected' : '' }}>index, nofollow</option>
                    <option value="noindex, nofollow" {{ old('robots', $article->robots) == 'noindex, nofollow' ? 'selected' : '' }}>noindex, nofollow</option>
                  </select>
                </div>
              </div>
